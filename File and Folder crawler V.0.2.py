...
class calc():
    ...
    def addition():
        try:
            ...
            add_item_int_01 = int(add_item_01)
            add_item_int_02 = int(add_item_02)
    ...
    def subtraction():
        try:
            ...
            sub_item_int_01 = int(sub_item_01)
            sub_item_int_02 = int(sub_item_02)
    ...
    def multiplication():
        try:
            ...
            mult_item_int_01 = int(mult_item_01)
            mult_item_int_02 = int(mult_item_02)
    ...
    def division():
        try:
            ...
            div_item_int_01 = int(div_item_01)
            div_item_int_02 = int(div_item_02)
